...
| `openai` | `strict` + every object closed (`additionalProperties: false`), as OpenAI strict function calling requires. Typed maps (schema-valued `additionalProperties`) are left alone                                                                                                                        |
